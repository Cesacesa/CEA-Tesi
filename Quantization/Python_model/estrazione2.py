...
# Uso per simple_cnn_fp8
onnx_path_fp8 = "./Quantization/Nets/simple_cnn_fp8.onnx"
params_fp8 = extract_quant_params_from_onnx(onnx_path_fp8)

for node, p in params_fp8.items():
    print(f"Node: {node}")

...
#define CONV_0_ICH 512 // input channels
...
#define CONV_0_OCH 512 // output channels
...
#define CONV_1_OCH 512 // Numero di canali output
...
#define CONV_2_OCH 8 // input channels
...
typedef ap_uint<8> memory_in_t;
typedef ap_int<32> memory_out_t;
...
using mem_in_t  = ap_uint<8>;
// ‑‑ Output data (64‑bit axis + TLAST)
using mem_out_t = ap_axiu<32,0,0,0>;

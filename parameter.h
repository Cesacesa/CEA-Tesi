...
#define CONV_0_IW 13 // input width
#define CONV_0_IH 13 // input height
...
#define CONV_1_FW 5 // filter width 
#define CONV_1_FH 5 // filter height
...
#define CONV_2_FW 3 // filter width 
#define CONV_2_FH 3 // filter height
...
typedef ap_int<45> memory_out_t[CONV_0_OH][CONV_0_OW][CONV_0_OCH];

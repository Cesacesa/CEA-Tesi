...
HLS_SOURCES = ../../../../conv_tb.cpp ../../../../top_wrapper.cpp
...
$(ObjDir)/conv_tb.o: ../../../../conv_tb.cpp $(ObjDir)/.dir csim.mk
...
$(ObjDir)/top_wrapper.o: ../../../../top_wrapper.cpp $(ObjDir)/.dir csim.mk
	$(Echo) "   Compiling ../../../../top_wrapper.cpp in $(BuildMode) mode" $(AVE_DIR_DLOG)
	$(Verb)  $(CXX) -std=gnu++14 ${CCFLAG} -c -MMD  $(IFLAG) $(DFLAG) $< -o $@ ; \

-include $(ObjDir)/top_wrapper.d

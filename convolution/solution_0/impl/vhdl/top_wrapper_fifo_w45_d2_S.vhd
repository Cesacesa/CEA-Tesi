...
entity top_wrapper_fifo_w45_d2_S is 
    generic (
...
architecture rtl of top_wrapper_fifo_w45_d2_S is
------------------------Task and function--------------
------------------------Parameter----------------------
constant SRL_DEPTH  : INTEGER := DEPTH;
constant SRL_AWIDTH : INTEGER := ADDR_WIDTH;
------------------------Component----------------------
    component top_wrapper_fifo_w45_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 45;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_top_wrapper_fifo_w45_d2_S_ShiftReg : top_wrapper_fifo_w45_d2_S_ShiftReg
    generic map (
...
entity top_wrapper_fifo_w45_d2_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 45;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end top_wrapper_fifo_w45_d2_S_ShiftReg;

architecture rtl of top_wrapper_fifo_w45_d2_S_ShiftReg is

...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "top_wrapper.autotvin.dat"
	set constFileTvOut       "top_wrapper.autotvout.dat"
	set constFileHdlTvIn     "top_wrapper.autohdltvin.dat"
	set constFileHdlTvOut    "top_wrapper.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"

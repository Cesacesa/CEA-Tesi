...
proc check_tvin_file {} {
    ...
    set rtlfilelist {
         "c.top_wrapper.autotvin_gmem2.dat"
         "c.top_wrapper.autotvin_memory_in.dat"
         "c.top_wrapper.autotvin_filter_val.dat"
         "c.top_wrapper.autotvin_memory.dat"
    }
...
proc check_tvout_file {} {
    ...
    set rtlfilelist {
         "rtl.top_wrapper.autotvout_gmem1.dat"
    }
    foreach rtlfile $rtlfilelist {
        if {[file isfile $rtlfile]} {
        } else {

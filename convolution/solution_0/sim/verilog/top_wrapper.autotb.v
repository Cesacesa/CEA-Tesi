...
`define AUTOTB_DUT      top_wrapper
`define AUTOTB_DUT_INST AESL_inst_top_wrapper
`define AUTOTB_TOP      apatb_top_wrapper_top
`define AUTOTB_LAT_RESULT_FILE "top_wrapper.result.lat.rb"
`define AUTOTB_PER_RESULT_TRANS_FILE "top_wrapper.performance.result.transaction.xml"
`define AUTOTB_TOP_INST AESL_inst_apatb_top_wrapper_top
`define AUTOTB_MAX_ALLOW_LATENCY  15000000
`define AUTOTB_CLOCK_PERIOD_DIV2 2.50

`define AESL_DEPTH_gmem2 1
`define AESL_DEPTH_gmem1 1
`define AESL_DEPTH_memory_in 1
`define AESL_DEPTH_filter_val 1
`define AESL_DEPTH_memory 1
`define AUTOTB_TVIN_gmem2  "../tv/cdatafile/c.top_wrapper.autotvin_gmem2.dat"
`define AUTOTB_TVIN_memory_in  "../tv/cdatafile/c.top_wrapper.autotvin_memory_in.dat"
`define AUTOTB_TVIN_filter_val  "../tv/cdatafile/c.top_wrapper.autotvin_filter_val.dat"
`define AUTOTB_TVIN_memory  "../tv/cdatafile/c.top_wrapper.autotvin_memory.dat"
`define AUTOTB_TVIN_gmem2_out_wrapc  "../tv/rtldatafile/rtl.top_wrapper.autotvin_gmem2.dat"
`define AUTOTB_TVIN_memory_in_out_wrapc  "../tv/rtldatafile/rtl.top_wrapper.autotvin_memory_in.dat"
`define AUTOTB_TVIN_filter_val_out_wrapc  "../tv/rtldatafile/rtl.top_wrapper.autotvin_filter_val.dat"
`define AUTOTB_TVIN_memory_out_wrapc  "../tv/rtldatafile/rtl.top_wrapper.autotvin_memory.dat"
`define AUTOTB_TVOUT_gmem1  "../tv/cdatafile/c.top_wrapper.autotvout_gmem1.dat"
`define AUTOTB_TVOUT_gmem1_out_wrapc  "../tv/rtldatafile/rtl.top_wrapper.autotvout_gmem1.dat"
module `AUTOTB_TOP;

parameter AUTOTB_TRANSACTION_NUM = 1;
parameter PROGRESS_TIMEOUT = 10000000;
parameter LATENCY_ESTIMATION = -1;
parameter LENGTH_filter_val = 1;
parameter LENGTH_gmem1 = 1210;
parameter LENGTH_gmem2 = 100;
parameter LENGTH_memory = 1;
parameter LENGTH_memory_in = 2250;
...
`AUTOTB_DUT `AUTOTB_DUT_INST(
    ...
    .s_axi_gmem3_AWADDR(gmem3_AWADDR),
    .s_axi_gmem3_AWVALID(gmem3_AWVALID),
    .s_axi_gmem3_AWREADY(gmem3_AWREADY),
    .s_axi_gmem3_WVALID(gmem3_WVALID),
    .s_axi_gmem3_WREADY(gmem3_WREADY),
    .s_axi_gmem3_WDATA(gmem3_WDATA),
    .s_axi_gmem3_WSTRB(gmem3_WSTRB),
    .s_axi_gmem3_ARADDR(gmem3_ARADDR),
    .s_axi_gmem3_ARVALID(gmem3_ARVALID),
    .s_axi_gmem3_ARREADY(gmem3_ARREADY),
    .s_axi_gmem3_RVALID(gmem3_RVALID),
    .s_axi_gmem3_RREADY(gmem3_RREADY),
    .s_axi_gmem3_RDATA(gmem3_RDATA),
    .s_axi_gmem3_RRESP(gmem3_RRESP),
    .s_axi_gmem3_BVALID(gmem3_BVALID),
    .s_axi_gmem3_BREADY(gmem3_BREADY),
    .s_axi_gmem3_BRESP(gmem3_BRESP),
    .ap_clk(ap_clk),
    .ap_rst_n(ap_rst_n),
...
assign AESL_continue = tb_continue;
  assign AESL_slave_write_start_in = slave_start_status  & gmem3_write_data_finish & control_r_write_data_finish;
...
AESL_axi_slave_gmem3 AESL_AXI_SLAVE_gmem3(
    .clk   (AESL_clock),
    .reset (AESL_reset),
    .TRAN_s_axi_gmem3_AWADDR (gmem3_AWADDR),
    .TRAN_s_axi_gmem3_AWVALID (gmem3_AWVALID),
    .TRAN_s_axi_gmem3_AWREADY (gmem3_AWREADY),
    .TRAN_s_axi_gmem3_WVALID (gmem3_WVALID),
    .TRAN_s_axi_gmem3_WREADY (gmem3_WREADY),
    .TRAN_s_axi_gmem3_WDATA (gmem3_WDATA),
    .TRAN_s_axi_gmem3_WSTRB (gmem3_WSTRB),
    .TRAN_s_axi_gmem3_ARADDR (gmem3_ARADDR),
    .TRAN_s_axi_gmem3_ARVALID (gmem3_ARVALID),
    .TRAN_s_axi_gmem3_ARREADY (gmem3_ARREADY),
    .TRAN_s_axi_gmem3_RVALID (gmem3_RVALID),
    .TRAN_s_axi_gmem3_RREADY (gmem3_RREADY),
    .TRAN_s_axi_gmem3_RDATA (gmem3_RDATA),
    .TRAN_s_axi_gmem3_RRESP (gmem3_RRESP),
    .TRAN_s_axi_gmem3_BVALID (gmem3_BVALID),
    .TRAN_s_axi_gmem3_BREADY (gmem3_BREADY),
    .TRAN_s_axi_gmem3_BRESP (gmem3_BRESP),
    .TRAN_gmem3_write_data_finish(gmem3_write_data_finish),
    .TRAN_gmem3_ready_in (AESL_slave_ready),
    .TRAN_gmem3_done_in (AESL_slave_output_done),
    .TRAN_gmem3_idle_in (AESL_idle),
    .TRAN_gmem3_transaction_done_in (AESL_done_delay),
    .TRAN_gmem3_start_in  (AESL_slave_start)
);
...
reg end_memory_in;
reg [31:0] size_memory_in;
reg [31:0] size_memory_in_backup;
reg end_filter_val;
reg [31:0] size_filter_val;
reg [31:0] size_filter_val_backup;
reg end_memory;
reg [31:0] size_memory;
reg [31:0] size_memory_backup;
reg end_gmem1;
reg [31:0] size_gmem1;

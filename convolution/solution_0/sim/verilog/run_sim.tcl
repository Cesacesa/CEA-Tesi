...
if {[file isfile top_wrapper.autotvin.dat]} {
	file delete -force top_wrapper.autotvin.dat
}

if {[file isfile top_wrapper.autotvout.dat]} {
	file delete -force top_wrapper.autotvout.dat
}

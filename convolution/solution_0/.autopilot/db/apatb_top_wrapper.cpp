...
#define AUTOTB_TVOUT_memory_in "../tv/cdatafile/c.top_wrapper.autotvout_memory_in.dat"
#define AUTOTB_TVIN_filter_val "../tv/cdatafile/c.top_wrapper.autotvin_filter_val.dat"
#define AUTOTB_TVOUT_filter_val "../tv/cdatafile/c.top_wrapper.autotvout_filter_val.dat"
#define AUTOTB_TVIN_memory "../tv/cdatafile/c.top_wrapper.autotvin_memory.dat"
#define AUTOTB_TVOUT_memory "../tv/cdatafile/c.top_wrapper.autotvout_memory.dat"
#define AUTOTB_TVIN_gmem1 "../tv/cdatafile/c.top_wrapper.autotvin_gmem1.dat"
...
#define AUTOTB_TVOUT_gmem2 "../tv/cdatafile/c.top_wrapper.autotvout_gmem2.dat"


// tvout file define:
#define AUTOTB_TVOUT_PC_gmem1 "../tv/rtldatafile/rtl.top_wrapper.autotvout_gmem1.dat"
#define AUTOTB_TVOUT_PC_gmem2 "../tv/rtldatafile/rtl.top_wrapper.autotvout_gmem2.dat"
...
extern "C"
void top_wrapper_hw_stub_wrapper(void*, void*, void*);

extern "C"
void apatb_top_wrapper_hw(void* __xlx_apatb_param_memory_in, void* __xlx_apatb_param_filter_val, void* __xlx_apatb_param_memory)
{
  hls::sim::Byte<4> __xlx_offset_byte_param_filter_val;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_filter_val),
#endif
  };
  port0.param = &__xlx_offset_byte_param_filter_val;

  hls::sim::Byte<4> __xlx_offset_byte_param_memory;
...
#else
    .owriter = nullptr,
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_memory),
#endif
  };
  port1.param = &__xlx_offset_byte_param_memory;
  ...
  port2.param = { __xlx_apatb_param_memory };
  port2.mname = { "memory" };
  port2.nbytes = { 9680 };
  ...
  port3.param = { __xlx_apatb_param_filter_val };
  port3.mname = { "filter_val" };
  port3.nbytes = { 400 };
  ...
  static hls::sim::Memory<hls::sim::Reader, hls::sim::Writer> port4 {
    ...
    .owriter = nullptr,
#ifdef USE_BINARY_TV_FILE
    .iwriter = new hls::sim::Output(AUTOTB_TVIN_memory_in),
#else
    .iwriter = new hls::sim::Writer(AUTOTB_TVIN_memory_in),
#endif
#endif
    .hasWrite = { false },
  };
  port4.param = { __xlx_apatb_param_memory_in };
  port4.mname = { "memory_in" };
  port4.nbytes = { 18000 };
  ...
  try {
    ...
    top_wrapper_hw_stub_wrapper(__xlx_apatb_param_memory_in, __xlx_apatb_param_filter_val, __xlx_apatb_param_memory);

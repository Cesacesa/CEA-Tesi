set moduleName dataflow_in_loop_VITIS_LOOP_92_1_1_Loop_VITIS_LOOP_99_2_proc
set isTopModule 0
...
set cdfgNum 13
set C_modelName {dataflow_in_loop_VITIS_LOOP_92_1.1_Loop_VITIS_LOOP_99_2_proc}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
set C_modelArgList {
	{ filter_val1 int 64 regular  }
	{ gmem2 int 32 regular {axi_master 0}  }
	{ filter2conv int 8 regular {fifo 1 volatile }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "filter_val1", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "filter2conv", "interface" : "fifo", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ filter2conv_din sc_out sc_lv 8 signal 2 } 
	{ filter2conv_full_n sc_in sc_logic 1 signal 2 } 
	{ filter2conv_write sc_out sc_logic 1 signal 2 } 
	{ filter2conv_num_data_valid sc_in sc_lv 8 signal 2 } 
	{ filter2conv_fifo_cap sc_in sc_lv 8 signal 2 } 
	{ filter_val1 sc_in sc_lv 64 signal 0 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "filter2conv_din", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "filter2conv", "role": "din" }} , 
 	{ "name": "filter2conv_full_n", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "filter2conv", "role": "full_n" }} , 
 	{ "name": "filter2conv_write", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "filter2conv", "role": "write" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"Port" : [
			...
			{"Name" : "filter2conv", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "100", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	filter_val1 { ap_none {  { filter_val1 in_data 0 64 } } }
	...
	filter2conv { ap_fifo {  { filter2conv_din fifo_data_in 1 8 }  { filter2conv_full_n fifo_status 0 1 }  { filter2conv_write fifo_port_we 1 1 }  { filter2conv_num_data_valid fifo_status_num_data_valid 0 8 }  { filter2conv_fifo_cap fifo_update 0 8 } } }
}

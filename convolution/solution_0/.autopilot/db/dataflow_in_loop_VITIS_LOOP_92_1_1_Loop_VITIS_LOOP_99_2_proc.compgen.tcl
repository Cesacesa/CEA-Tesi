...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_filter_val1 \
    op interface \
    ports { filter_val1 { I 64 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_filter2conv \
    op interface \
    ports { filter2conv_din { O 8 vector } filter2conv_full_n { I 1 bit } filter2conv_write { O 1 bit } filter2conv_num_data_valid { I 8 vector } filter2conv_fifo_cap { I 8 vector } } \
} "
}
...
set InstName top_wrapper_flow_control_loop_pipe_U
set CompName top_wrapper_flow_control_loop_pipe

...
set name top_wrapper_mul_3ns_12ns_13_1_1
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler top_wrapper_sparsemux_19_5_32_1_1 BINDTYPE {op} TYPE {sparsemux} IMPL {compactencoding_dontcare}
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_memory \
    op interface \
    ports { memory_dout { I 64 vector } memory_empty_n { I 1 bit } memory_read { O 1 bit } memory_num_data_valid { I 3 vector } memory_fifo_cap { I 3 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_img_0 \
    op interface \
    ports { img_0_dout { I 3 vector } img_0_empty_n { I 1 bit } img_0_read { O 1 bit } img_0_num_data_valid { I 3 vector } img_0_fifo_cap { I 3 vector } } \
} "
}
